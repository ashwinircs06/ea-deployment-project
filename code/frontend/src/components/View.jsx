...
const navigation = [
    ...
    { name: 'View Profile', href: '/view', current: true },
                ...
                <main className="-mt-32">
                    <div className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
                        <div className="rounded-lg bg-white px-5 py-6 shadow sm:px-6">
                            <h1 className="text-3xl mb-6 font-semibold text-gray-700">User Information</h1>
                                ...
                                {user ? (
                                    <>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-800 font-medium">{user.dateofbirth}</p>
                                        </div>
                                    </>
                                ) : (
                                    <p className="text-sm text-gray-500 font-serif">Loading user data...</p>
                                )}
                            </div>
                        </div>
                    </div>

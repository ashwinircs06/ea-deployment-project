...
const navigation = [
    ...
    { name: 'Edit Profile', href: '/edit', current: false },
...
export default function Example() {
    const [user, setUserData] = useState({
        imageUrl:
            'https://img.lovepik.com/free-png/20211102/lovepik-cat-png-image_400202046_wh1200.png',
    });
                ...
                <main className="-mt-32">
                    <div className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
                        <div className="rounded-lg bg-white px-5 py-6 shadow sm:px-6">
                            <div className="pb-6">
                                <p className="text-lg font-semibold text-gray-700">Welcome to the React.js project!</p>
                                <p className="mt-4 text-sm text-gray-500">
                                    This project allows users to sign up, log in, view their information, and edit their profile details. It's a full-stack web application built using React.js for the front end and Node.js with Express.js for the backend.
                                </p>
                            </div>
                            <div className="pb-6">
                                <p className="text-lg font-semibold text-gray-700">Technologies Used:</p>
                                <p className="mt-4 text-sm text-gray-500">
                                    The front end is developed using React.js, a popular JavaScript library for building user interfaces. Tailwind CSS is used for styling, providing a clean and modern design.
                                </p>
                                <p className="mt-4 text-sm text-gray-500">
                                    On the backend, Node.js and Express.js are used to handle user authentication, profile management, and database operations. MySQL is used as the database management system for storing user data securely.
                                </p>
                                <p className="mt-4 text-sm text-gray-500">
                                    Additionally, Docker is utilized for containerization, allowing for easy deployment and scaling of the application across different environments.
                                </p>
                            </div>
                            <div className="pb-6">
                                <p className="text-lg font-semibold text-gray-700">New Features:</p>
                                <p className="mt-4 text-sm text-gray-500">
                                    This project demonstrates various features of React.js, including state management, routing, and component composition. It also implements user authentication using JSON Web Tokens (JWT) for secure access to protected routes.
                                </p>
                                <p className="mt-4 text-sm text-gray-500">
                                    Users can sign up for a new account by providing their details, log in using their credentials, and view their profile information. They can also edit their profile details as needed.
                                </p>
                            </div>
                            <div>
                                <p className="text-lg font-semibold text-gray-700">Happy Coding!</p>
                                <p className="mt-4 text-sm text-gray-500">
                                    Feel free to explore the project and experiment with different functionalities. Happy coding, and enjoy building with React.js!
                                </p>
                            </div>
                        </div>
                    </div>
